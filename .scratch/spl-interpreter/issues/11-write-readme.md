...
architecture (point at CONTEXT.md and docs/adr/), the supported language subset and known gaps
(link these issues), and how to run the checks (`uv run ruff check`, `uv run pyright`,
`uv run pytest`).
